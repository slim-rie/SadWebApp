...
class OrderCancellation(db.Model):
    ...
    cancelled_at = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)  # <-- Add this line
    other_reason = db.Column(db.Text, nullable=True)  # (if you use this field)
